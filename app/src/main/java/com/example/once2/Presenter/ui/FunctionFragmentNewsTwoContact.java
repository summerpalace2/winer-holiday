 ...
 * date : 2025/2/7 11:21
 */
public interface FunctionFragmentNewsTwoContact {
    public interface Model{
        public void startPost(Handler handler);//启动网络请求
        public void doGSon(String data, FunctionFragmentNewsTwoContact.Presenter callback);//接受Presenter层的handler数据
    }
